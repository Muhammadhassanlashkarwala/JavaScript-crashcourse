...
//? 5: Object.freeze(): Freezes an object, preventing new properties from being added to it and existing properties from being modified or deleted.
...
// ===========================================
//! Give an object representing a student, write a function to add a new subject with its corresponding grade to the student's record. Also check if the grades property its present or not?
...
let objB = {name: "Alice", age: 30, city: "New York"};
let objC = {name: "Pop", age: 25, city: "Florida"};

const areObjectEqual = (obj1, obj2) => {
 
}

console.log(areObjectEqual(objA, objB));   // should return: true
console.log(areObjectEqual(objA, objC));   // should return: false
